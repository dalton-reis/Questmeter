...
var AlunoService = /** @class */ (function () {
    function AlunoService(db) {
        this.db = db;
        this.collectionAlunos = db.collection('alunos');
        this.listAlunos = this.collectionAlunos.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (actions) {
    ...
    AlunoService.prototype.getAll = function () {
        return this.listAlunos;
    };
    AlunoService.prototype.get = function (id) {
        return this.collectionAlunos.doc(id).valueChanges();
    };
    AlunoService.prototype.getByUsuario = function (usuario) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.db.collection('alunos', function (ref) { return ref.where('usuario', '==', usuario); }).
    ...
    AlunoService.prototype.getByUsuarioA = function (usuario) {
        return this.db.collection('alunos', function (ref) { return ref.where('usuario', '==', usuario); }).
            snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (actions) {
            return actions.map(function (a) {
                var data = a.payload.doc.data();
                var id = a.payload.doc.id;
    ...
    AlunoService.prototype.add = function (aluno) {
        return this.collectionAlunos.add(aluno);
    };
    AlunoService.prototype.update = function (id, aluno) {
        return this.collectionAlunos.doc(id).update(aluno);
    };
    AlunoService.prototype.remove = function (id) {
        return this.collectionAlunos.doc(id).delete();
    };
    AlunoService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var AutenticacaoService = /** @class */ (function () {
    function AutenticacaoService(angularFireAuth) {
        this.angularFireAuth = angularFireAuth;
    }
    AutenticacaoService.prototype.createUser = function (usuario) {
        return this.angularFireAuth.auth.createUserWithEmailAndPassword(usuario.email, usuario.senha);
    };
    AutenticacaoService.prototype.updateUserPassword = function (novaSenha) {
        return this.angularFireAuth.auth.currentUser.updatePassword(novaSenha);
    };
    AutenticacaoService.prototype.signIn = function (usuario) {
        return this.angularFireAuth.auth.signInWithEmailAndPassword(usuario.email, usuario.senha);
    };
    AutenticacaoService.prototype.signOut = function () {
        return this.angularFireAuth.auth.signOut();
    };
    AutenticacaoService.prototype.resetPassword = function (email) {
        return this.angularFireAuth.auth.sendPasswordResetEmail(email);
    };
    AutenticacaoService.prototype.getID = function () {
        return this.angularFireAuth.auth.currentUser.uid;
    };
    AutenticacaoService.prototype.getEmail = function () {
...
var ProfessorService = /** @class */ (function () {
    function ProfessorService(db) {
        this.db = db;
        this.collectionProfessores = db.collection('professores');
        this.listProfessores = this.collectionProfessores.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (actions) {
            return actions.map(function (a) {
                var data = a.payload.doc.data();
                var id = a.payload.doc.id;
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ id: id }, data);
    ...
    ProfessorService.prototype.getAll = function () {
        return this.listProfessores;
    };
    ProfessorService.prototype.get = function (id) {
        return this.collectionProfessores.doc(id).valueChanges();
    };
    ProfessorService.prototype.getByUsuario = function (usuario) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.db.collection('professores', function (ref) { return ref.where('usuario', '==', usuario); }).
                snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (actions) {
                return actions.map(function (a) {
                    var data = a.payload.doc.data();
                    var id = a.payload.doc.id;
    ...
    ProfessorService.prototype.add = function (professor) {
        return this.collectionProfessores.add(professor);
    };
    ProfessorService.prototype.update = function (id, professor) {
        return this.collectionProfessores.doc(id).update(professor);
    };
    ProfessorService.prototype.remove = function (id) {
