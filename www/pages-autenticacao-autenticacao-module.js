...
/* harmony import */ var _services_autenticacao_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../../services/autenticacao.service */ "./src/app/services/autenticacao.service.ts");
...
var AutenticacaoPage = /** @class */ (function () {
    function AutenticacaoPage(route, nav, toastController, autenticacaoService, alunoService, professorService) {
        this.route = route;
        this.nav = nav;
                ...
                if (this.form.form.valid) {
                    ...
                    this.autenticacaoService.signIn(this.usuario)
                        ...
                        if (_this.tipoUsuario == 'aluno') {
                            _this.alunoService.getByUsuario(usuario.user.uid).then(function (resultado) {
                                if (resultado[0]) {
                                    _this.nav.navigateForward('/aluno-inicio');
                                }
                                else {
                                    _this.presentToast("Você não está cadastrado como aluno.");
                                }
                            });
                        }
                        else if (_this.tipoUsuario == 'professor') {
                            _this.professorService.getByUsuario(usuario.user.uid).then(function (resultado) {
                                if (resultado[0]) {
                                    _this.nav.navigateForward('/professor-inicio');
                                }
                                else {
                                    _this.presentToast("Você não está cadastrado como professor.");
                                }
                            });
                        }
                    })
    ...
    AutenticacaoPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"],
            ...
            _services_autenticacao_service__WEBPACK_IMPORTED_MODULE_5__["AutenticacaoService"],
            _services_aluno_service__WEBPACK_IMPORTED_MODULE_2__["AlunoService"],
            _services_professor_service__WEBPACK_IMPORTED_MODULE_1__["ProfessorService"]])
    ], AutenticacaoPage);
